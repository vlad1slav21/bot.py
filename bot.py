    ...
    try:
        if state == STEP_START:
            if text == 'Купить':
                ...
                reply_markup = ReplyKeyboardMarkup(keyboard_products, resize_keyboard=True, one_time_keyboard=True)
                await update.message.reply_text('Выберите продукт:', reply_markup=reply_markup)
            else:
                await update.message.reply_text('Нажмите кнопку "Купить" или /start.')
            ...
            if text in PRODUCTS:
                ...
                keyboard_weights = [[f"{w} - {PRODUCTS[text][w]}"] for w in PRODUCTS[text]]
                reply_markup = ReplyKeyboardMarkup(keyboard_weights, resize_keyboard=True, one_time_keyboard=True)
                await update.message.reply_text('Выберите вес продукта:', reply_markup=reply_markup)
            else:
                await update.message.reply_text('Выберите продукт из списка или /start.')
            ...
            if selected_weight:
                ...
                keyboard_cities = [[c] for c in CITIES]
                reply_markup = ReplyKeyboardMarkup(keyboard_cities, resize_keyboard=True, one_time_keyboard=True)
                await update.message.reply_text('Выберите город доставки:', reply_markup=reply_markup)
            else:
                await update.message.reply_text('Выберите вес из списка или /start.')
            ...
            if text in CITIES:
                ...
                keyboard_districts = [[d] for d in CITIES[text]]
                reply_markup = ReplyKeyboardMarkup(keyboard_districts, resize_keyboard=True, one_time_keyboard=True)
                await update.message.reply_text(f'Выберите район в городе {text}:', reply_markup=reply_markup)
            else:
                await update.message.reply_text('Выберите город из списка или /start.')
            ...
            if text in CITIES[city]:
                ...
                await update.message.reply_text(f'Выберите район из списка для города {city} или /start.')
