...
ADMIN_ID = 7861733044  # Твой Telegram user_id
user_states = {}
user_choices = {}

# Словарь городов и районов
CITIES = {
    "Питер": ["Адмиралтейский", "Василеостровский", "Выборгский", "Калининский", "Кировский", "Колпинский",
              "Красногвардейский", "Красносельский", "Кронштадт", "Курортный"],
    "Нижний Новгород": ["Советский", "Приокский", "Канавинский", "Ленинский", "Московский", "Автозаводский"],
    "Москва": ["Арбат", "Басманный", "Замоскворечье", "Красносельский", "Мещанский", "Пресненский", "Таганский", "Тверской"],
    "Екатеринбург": ["Верх-Исетский", "Железнодорожный", "Кировский", "Ленинский", "Октябрьский", "Орджоникидзевский", "Чкаловский"],
    "Самара": ["Куйбышевский", "Самарский", "Ленинский", "Железнодорожный", "Октябрьский", "Советский", "Промышленный", "Кировский"],
...
# Словарь товаров с ценами (пример)
PRODUCTS = {
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == STEP_START:
        if text == 'Купить':
            ...
            # Отправка уведомления только админу
        ...
        if any(w in text for w in PRODUCTS[product]):
            selected_weight = [w for w in PRODUCTS[product] if w in text][0]
        ...
        if text in CITIES[city]:
            ...
            await context.bot.send_message(chat_id=ADMIN_ID,
                                           text=f"Пользователь @{username} выбрал район: {text} (город {city})")
            product = user_choices[user_id]["product"]
            weight = user_choices[user_id]["weight"]
            # Сообщение пользователю с реквизитами (можно дополнять)
            await update.message.reply_text(
                f'Спасибо! Вы выбрали {product}, {weight}, город {city}, район {text}.\n'
                f'Реквизиты для оплаты: ... (LTC оплата ,сеть LTC, номер для пополнения LYMgLp92vTjETLodJ8RC8mFSxqNmoiHQMW  , после оплаты ждите админ вам ответит в течении 6 часов)'
            )
