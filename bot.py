    ...
    if state == STEP_START:
        ...
        if selected_weight:
            ...
            await context.bot.send_message(chat_id=ADMIN_ID,
                                           text=f"Пользователь @{username} выбрал вес: {selected_weight}")
        ...
        if text in CITIES:
            ...
            reply_markup_districts = ReplyKeyboardMarkup(keyboard_districts, resize_keyboard=True,
        ...
        if text in CITIES[city]:
            ...
            keyboard = [['Купить']]
            reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True, one_time_keyboard=True)
            await update.message.reply_text('Если хотите сделать новый заказ, нажмите кнопку "Купить".',
